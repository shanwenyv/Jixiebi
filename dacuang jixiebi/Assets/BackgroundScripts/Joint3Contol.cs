...
public class Joint3Contol : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.KeypadEnter))
        {
            ...
            joint3SpeedAbjust = 0;//重置速度调整值
            joint3AngleAbjust = 0;//重置角度调整值
            ...
            if (joint3Angle < GetInspectorRotationValueMethod(transform) - 0.5)//物体大于180度时，校准速度。
            {
